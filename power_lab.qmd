...
\- What statistical test was used? (t-test, ANOVA, regression, etc.)

\- What are the key predictors or comparisons?
...
pwr.f2.test(u = 1, f2 = your_f2, sig.level = 0.05, power = 0.80)
